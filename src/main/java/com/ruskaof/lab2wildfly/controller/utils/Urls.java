...
public final class Urls {
    ...
    public static String vkOauthAuthorizePage(String clientId, String redirectUrl) {
        return "https://oauth.vk.com/authorize?client_id=" + clientId + "&redirect_uri=" + redirectUrl;
    }

    public static String vkOauthGetAccessToken(String clientId, String redirectUrl, String clientSecret, String code) {
